        ...
        <section class="features-section">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    ...
                    <p class="feature-card__text">Nasz system śledzi Twoje postępy i oferuje inteligentne funkcje doboru pytań.</p>
                    <div class="feature-card__details">
                        <p>
                            Ucz się mądrzej z naszymi inteligentnymi funkcjami:
                        </p>
                        <ul class="feature-card__list">
                            <li><strong>Cztery tryby nauki:</strong> Aplikacja oferuje wyjątkowe tryby nauki maksymalizujące efekty Twojej pracy.</li>
                            <li>
                                <strong>Gotowe wyjaśnienia:</strong> Każde pytanie zawiera szczegółowe wyjaśnienie, dzięki czemu nie tracisz cennego czasu na szukanie odpowiedzi.
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="feature-card">
                    ...
                    <div class="feature-card__details">
                        <p>
                            Analizuj swoją skuteczność w każdym dziale dzięki czytelnym wykresom i tabelom. Obserwuj, jak rośnie Twoja gotowość do egzaminu – wszystkie te funkcje są dostępne już w darmowym koncie!
                        </p>
                    </div>
                </div>
                <div class="feature-card">
                    ...
                    <p class="feature-card__text">Pobieraj gotowe do druku arkusze PDF i ćwicz w warunkach zbliżonych do prawdziwego egzaminu.</p>
                    <div class="feature-card__details">
                        <p>Każdy arkusz to kompletny zestaw zadań praktycznych, który pomoże Ci oswoić się z formą egzaminu. (Wkrótce!)</p>
                    </div>
                </div>
                <div class="feature-card">
                    <div class="feature-card__header">
                    ...
                    <p class="feature-card__text">Skorzystaj z naszych kompleksowych kursów wideo, które przeprowadzą Cię przez każdy temat.</p>
                    <div class="feature-card__details">
                        <p>Nasi eksperci tłumaczą najtrudniejsze zagadnienia w prosty i zrozumiały sposób, krok po kroku. (Wkrótce!)</p>
                    </div>
                </div>
                <div class="feature-card">
                    <div class="feature-card__header">
                    ...
                    <p class="feature-card__text">Ucz się bez przeszkód dzięki prostemu i intuicyjnemu interfejsowi na każdym urządzeniu.</p>
                    <div class="feature-card__details">
                        <p>Zaprojektowaliśmy Examly tak, aby nic nie odciągało Twojej uwagi od tego, co najważniejsze – efektywnej nauki.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="exams-grid">
                ...
                <a href="#" class="exam-card exam-card--disabled">
                    ...
                    <div class="exam-card__content">
                        ...
                        <p class="exam-card__subtitle">Sprzęt, systemy i sieci<br><span class="exam-card__soon">Wkrótce!</span></p>
                    </div>
                </a>
            </div>
        </section>
            ...
            <div class="info-grid">
                <div class="info-block">
                    ...
                    <p class="info-block__answer">
                        Egzamin podzielony jest na dwie kluczowe części: pisemną i praktyczną. Etap pisemny to test wyboru trwający <strong>60 minut</strong>, składający się z 40 pytań z jedną prawidłową odpowiedzią. Etap praktyczny to zadanie do wykonania przy komputerze, na które przeznaczone jest <strong>240 minut</strong>.
                    </p>
                </div>
                <div class="info-block">
                ...
                <div class="info-block">
                    ...
                    <p class="info-block__answer">
                        Warunkiem zdania całego egzaminu jest zaliczenie obu jego części. Jeśli nie powiedzie Ci się tylko w jednej z nich, możesz przystąpić do <strong>poprawki wyłącznie tej części</strong>. Oblanie obu etapów wiąże się z koniecznością ponownego zdawania całego egzaminu.
                    </p>
                </div>
                <div class="info-block">
                    <h3 class="info-block__question">Czy muszę podchodzić do egzaminu?</h3>
                    <p class="info-block__answer">
                        Dla uczniów technikum w nowej formule (od 2019 r., kwalifikacje INF.02 i INF.03), <strong>podejście do egzaminu jest obowiązkowe</strong> w celu ukończenia szkoły. Pamiętaj jednak, że jego wynik (nawet 0%) <strong>nie wpływa na promocję</strong> do następnej klasy ani na ukończenie szkoły.
                    </p>
                </div>
            </div>
        </section>
